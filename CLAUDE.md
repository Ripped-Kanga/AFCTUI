...
- `pcm_alaw` / `pcm_mulaw` (and any future codec-specific constraints) are defined once in `converter.CODEC_CONSTRAINTS`. Both UIs read from this — they do not hard-code codec behaviour themselves.
